...
[Live2D](https://www.live2d.com) 是由日本公司 Live2D Inc. 开发的一套 2D 动画技术。它通过对 2D 插画进行网格分割和形变，使插画人物能够做出自然流畅的动作——头部转动、眨眼、嘴巴开合、衣物摆动等，而无需逐帧绘制每个动作。这让画师只需提供一张高精度插画，就能制作出媲美 3D 动画的动态效果。
...
官方提供了 [Cubism SDK](https://www.live2d.com/sdk/about/) 用于在各类平台上渲染和驱动 Live2D 模型，`l2d` 是基于其 Web 版本的二次封装。
