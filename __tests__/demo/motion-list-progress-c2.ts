...
function setupInstance(l2d: L2D, path: string) {
...
export default {
  ...
  canvasCount: 2,
  setup([l2d, l2d2]) {
    const cleanup1 = setupInstance(l2d, 'https://model.hacxy.cn/HK416-1-normal/model.json');
    const cleanup2 = setupInstance(l2d2, 'https://model.hacxy.cn/shizuku/shizuku.model.json');
